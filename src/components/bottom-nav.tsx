...
// Barra di navigazione principale, pensata mobile-first (PWA).
...
const voci = [
  ...
  { href: "/calendario", label: "Calendario", icona: IconaCalendario },
  { href: "/classifiche", label: "Classifiche", icona: IconaTrofeo },
  { href: "/giocatori", label: "Giocatori", icona: IconaSquadra },
...
export function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 z-10 border-t border-border bg-background pb-[env(safe-area-inset-bottom)]">
            ...
            <li key={href} className="flex-1">
              <Link
                ...
                className={`flex flex-col items-center gap-0.5 py-2 text-[11px] font-medium ${
                  attiva ? "text-brand" : "text-muted hover:text-foreground"
                }`}
              >
                <Icona />
                {label}
